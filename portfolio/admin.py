...
class DigitalCurrencyList(admin.ModelAdmin):
    list_display = ('customer','symbol', 'name', 'balance', 'purchase_price')
    list_filter = ('customer','symbol', 'name')
    search_fields = ('customer','symbol', 'name')
    ordering = ['customer']
...
admin.site.register(Digitalcurrency, DigitalCurrencyList)
